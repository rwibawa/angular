(function() {
	...
	app.controller('StoreController', [ '$http', function($http){
		var store = this;
		store.products = [];
		$http.get('includes/store-products.json').success(function(data){
			store.products = data;
		});
	} ]);
...
//			name: "Pentagonal Gem",
//			price: 5.95,
//			description: "Some gems have hidden qualities beyond their luster, beyond their shine.. Pentagonal Gem is one of them",
//			canPurchase: true,
//			soldOut: false
//		}
//	];
